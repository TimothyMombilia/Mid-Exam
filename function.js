const faculties = [
  ...
  },
  {
    ...
    sub: ["Pendidikan Agama", "Pendidikan Bahasa Inggris", "Pendidikan Ekonomi", "Pendidikan Luar Sekolah"],
  },
  {
...
const showhidebutton= document.querySelector("#sH");
const form = document.querySelector("#add");
const table = document.querySelector("table");


showhidebutton.addEventListener("click", t);
...
function t(event) {
  ...
  if (form.style.display == "none") {
    ...
    showhidebutton.textContent = "Hide Forms Add New Student";

  } else {
    form.style.display = "none";
    showhidebutton.textContent = "Show Forms Add New Student";
  }
}
